// bg.js – Professionelle Partikelanimation: Sammlung & Explosion
...
function drawParticles() {
  ...
  for (let p of particles) {
    ...
    if (phase === 'float') {
      ...
      p.alpha = Math.min(p.alpha + 0.01,1); // Aufhellen beim Sammeln
    } 
...
function animate() {
  ...
  // Steuerung Phasen (länger, smooth)
  if(timer%900===0) phase='gather';      // sammeln
  if(timer%900===300) phase='explode';   // langsam explodieren
