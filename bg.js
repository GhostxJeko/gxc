// bg.js – Partikel-Tunnel mit Strudel-Explosion (neutral -> bunt)
...
const particles = [];
const particleCount = 120; // Anfangs weniger Partikel
...
function createParticles() {
    ...
    for (let i = 0; i < particleCount; i++) {
        // Neutralfarben am Anfang: Weiß-Blau
...
function drawParticles() {
    ...
    for (let p of particles) {
        ...
        if (phase === 'float') {
            ...
            const swirl = 0.15; // stärkere Spirale
            ...
            if (p.alpha <= 0) {
                ...
                // Bunte Explosion: rot, gelb, weiß, blau (kein Lila)
