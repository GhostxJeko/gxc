...
/* ===== STERNE EINMAL GENERIEREN (kein Flackern) ===== */
const stars = [];
...
class Particle {
  ...
  reset(initial = false) {
    ...
    // Gleichmäßig im gesamten Canvas verteilen
    this.x = random(0, width);
    this.y = random(0, height);

    // Ruhige, hochwertige Bewegung
